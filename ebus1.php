...
<html lang="en" xmins="https.//www.w3.org/1999/xhtml"
  ...
  display: inline-block;
    ...
    <body style = background-color:yellow; background = https://images.pexels.com/photos/235994/pexels-photo-235994.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500>
    <a href="http://localhost:8000/index.php">Return To Index</a>
            ...
            <form name="intCalc" method="post" action="eBus2.php">
                ...
                <center>
                    <table cellspacing="10">
                        <tr>
                          <td><b> <h1 style = font-size:40px> Select a Consulting Service:</b></td> 
                        </tr>
                         <tr>
       ...
       <! Declaring variables and applying them to the prices->
